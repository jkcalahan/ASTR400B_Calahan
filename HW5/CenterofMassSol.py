...
print("MW Center of Mass Position:", MW_COMP[0],MW_COMP[1],MW_COMP[2])
print("MW Center of Mass Velocity:", MW_COMV[0],MW_COMV[1],MW_COMV[2])

# M31:   store the position and velocity COM 
M31_COMP = M31COM.COM_P(1.0)
M31_COMV = M31COM.COM_V(1.0)
print("M31 Center of Mass Position:", M31_COMP[0],M31_COMP[1],M31_COMP[2])
print("M31 Center of Mass Velocity:", M31_COMV[0],M31_COMV[1],M31_COMV[2])

# M33:   store the position and velocity COM 
M33_COMP = M33COM.COM_P(1.0)
M33_COMV = M33COM.COM_V(1.0)
print("M33 Center of Mass Position:", M33_COMP[0],M33_COMP[1],M33_COMP[2])
print("M33 Center of Mass Velocity:", M33_COMV[0],M33_COMV[1],M33_COMV[2])
...
M33_M31 = np.sqrt((M33_COMP[0]-M31_COMP[0])**2 + (M33_COMP[1]-M33_COMP[1])**2 + (M33_COMP[2]-M31_COMP[2])**2)
